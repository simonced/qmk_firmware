...
#define _MO 14 // has to be higher be activable from different layers
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //  - all other layers are deactivated but F (motion layer) so I can still use F1~F12
  [_GA] = LAYOUT(
    ...
    KC_LCTL, KC_A,    KC_S,  KC_D,  SW_ML, KC_G,    KC_DEL,                          KC_BSPC, KC_H,   KC_J,  KC_K,     KC_L,    KC_SCLN, KC_QUOT, \
