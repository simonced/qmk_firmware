...
// eigo - lower
#define ROMA_LW MT(MO(_LOWER), JP_MHEN)
// kana - upper
#define KANA_UP MT(MO(_RAISE), JP_HENK)
...
[_LOWER] = LAYOUT_ortho_4x12_1x2uC(
    ...
    _______, JP_0, KC_VOLD, KC_VOLU, _______,      KC_MPLY,      _______, _______, _______, _______, _______
),
...
[_RAISE] = LAYOUT_ortho_4x12_1x2uC(
    ...
    _______, KC_PSCR, KC_INS,  KC_BRK,  _______,      _______,     _______, KC_HOME, KC_PGDN, KC_PGUP, KC_END
),
